...
| **Agent Kit** | `/v1/agents`, `/v1/action/skills` | Budget-enforced AI agents that can sign transactions and pay for x402 resources |
...
|-------------|----------|-----|
| Sandbox | `https://relayer-api.onrender.com/v1` | Development and testing |
