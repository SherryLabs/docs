...
| **Action** | `/v1/action` | Blockchain action registry, transaction builders, token lists, on-chain indexing |
...
|-------------|----------|-----|
| Sandbox | `https://sandbox.relayer.fi` | Development and testing |
