---
title: "sherry-sdk"
description: "TypeScript SDK for building blockchain action metadata — works identically in both Turnkey Mode and Metadata Mode"
...
<Note>
The sherry-sdk metadata layer is **mode-agnostic**. Whether your integration uses Turnkey Mode (passkey signing) or Metadata Mode (bring your own wallet), the metadata schema and validation are identical. The SDK defines *what* action to perform — the integration mode determines *how* signing happens.
</Note>
