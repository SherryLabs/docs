...
|---|---|---|
| **Sandbox** | `https://relayer-api.onrender.com/v1` | Testing and development |
...
<Tabs>
  <Tab title="Sandbox">
    ...
    ```bash cURL
    curl https://relayer-api.onrender.com/v1/
    ```

    ```typescript Node.js
    const response = await fetch("https://relayer-api.onrender.com/v1/");
...
<Tabs>
  <Tab title="Sandbox">
    ...
    ```bash Terminal
    export RELAYER_BASE_URL="https://relayer-api.onrender.com/v1"
    export RELAYER_API_KEY="rk_client_key_v1_your_key_here"
    ```

    ```text .env file
    RELAYER_BASE_URL=https://relayer-api.onrender.com/v1
...
| Problem | Solution |
|---------|----------|
| `Connection refused` | Check `RELAYER_BASE_URL` — sandbox: `https://relayer-api.onrender.com/v1`, production: `https://api.relayer.fi/v1` |
