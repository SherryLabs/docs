...
- **MCP issues**: try `claude mcp remove relayer-docs` and re-add. If problems persist, [open a support email](mailto:support@relayer.fi).
- **AI assistants giving wrong answers**: this likely means the docs themselves are unclear or stale — please report at [support@relayer.fi](mailto:support@relayer.fi) and we'll fix the page.
