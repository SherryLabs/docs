...
- **Agent Kit (`/v1/agents/*`)** — Budget-enforced AI agents with USDC wallets on Solana and x402 payments. SDK: `@relayerfi/agent-sdk`.
...
- **Agent Kit** (`/v1/agents/*`) — Budget-enforced AI agents with USDC wallets and x402 payments
